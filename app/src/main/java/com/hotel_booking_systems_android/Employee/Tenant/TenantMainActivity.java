    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TenantMainActivity.this, com.hotel_booking_systems_android.Employee.Tenant.AddTenant.AddTenantActivity.class);
        ...
        roomlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TenantMainActivity.this, com.hotel_booking_systems_android.Employee.Room.RoomListActivity.class);
